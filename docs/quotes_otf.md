...
Quote Erstellen:
	...
	Paramter:	!addzitat QuoteName "Dein Quote Text" - Name, Jahreszahl
	Beispiel:	!addzitat lustigeszitat "Ich habe etwas lustiges gesagt" - LustigerStreamer, 2016 
...
Quote Text Editieren:
	Parameter:	!editquote text QuoteName "Dein Editierter Quote Text" - Name, Jahreszahl"
	Beispiel:	!editquote text lustigeszitat "Hier ist nun das Editierte Quote" - LustigerStreamer, 2016
...
Quotes Löschen:
	Parameter:	!delzitat QuoteName
	Parameter2:	!removezitat QuoteName
	Beispiel:	!delzitat Lustigeszitat
	Beispiel2:	!removezitat Lustigestitat
...
Mit dem Befehl "!delquote"/"!removequote" oder "!delzitat"/"!removezitat" vor dem QuoteNamen wird in diesem Beispiel das Quote "Lustigeszitat" gelöscht und steht dadurch nicht mehr zur Verfügung.
