...
Commands:
	...
	Möglichkeit ein Command zu erstellen.
		...
		Command Text:	Feld zum eintragen des Textes und der Parameter die beim Auführen des Command ausgegeben werden
			...
			"Costume"		- Nur Viewer mit einem Custom Userlevel können diesen Command benutzen (kann unter "Users" festgelegt werden)
	...
	Parameter um Commands Individuell an zu passen.
		...
		$[rnglist(listname)] - Gibt ein Zufälliges Item aus der Angegebenen Liste wieder (Listen und Items können unter "Items" angelegt werden)
