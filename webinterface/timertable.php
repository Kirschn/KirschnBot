        ...
        <tr>
            ...
            <?php if ($canmanage) {?>
                <td>
                    ...
                    ?>
                    <button type="submit" class="btn btn-primary" onclick="$.get('function/toggletimer.php?token=<?php echo $_SESSION["onetimetoken"]; ?>&id=<?php echo $r["id"]; ?>', function(data) {reload();})"><?php echo $vorsilbe; ?>able</button>
