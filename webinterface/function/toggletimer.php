...
mysqli_query($sqlconnection, "UPDATE timer SET active = (CASE active WHEN 1 THEN 0 ELSE 1 END) WHERE channel='#$username' AND id='". mysqli_real_escape_string($sqlconnection, $_GET["id"]) . "'");
?>