...
<li class="<?php echo ($_SERVER['PHP_SELF'] == "/filter.php" ? "" : "in")?>active"><a href="filter.php"><i class="fa fa-ban"></i> <span>Anti-Spam</span></a></li>
    ...
    <li class="<?php echo($_SERVER['PHP_SELF'] == "/timers.php" ? "" : "in") ?>active"><a href="timers.php"><i class="fa fa-clock-o"></i> <span>Timer</span></a></li>
<li class="<?php echo($_SERVER['PHP_SELF'] == "/botsettings.php" ? "" : "in") ?>active"><a href="botsettings.php"><i class="fa fa-wrench"></i> <span>Settings</span></a></li>
    <li class="<?php echo($_SERVER['PHP_SELF'] == "/docs" ? "" : "in") ?>active"><a target="blank" href="http://kirschnbot.readthedocs.io/de/latest/"><i class="fa fa-book"></i> <span>Docs (German)</span></a></li>
</ul><!-- /.sidebar-menu -->
